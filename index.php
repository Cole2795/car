...
<body>
	<header class="header" id="header">
		...
		<div class="container">
			...
			<h1 class="animated fadeInDown delay-07s">Welcome To Different Type of Cars</h1>
	...
	<section class="main-section paddind" id="Portfolio">
		<!--main-section-start-->
		<div class="container">
			<h2>Different Type of Cars</h2>
			<h6>Fresh cars of designs that will keep you wanting more.</h6>
			<div class="portfolioFilter">
				<ul class="Portfolio-nav wow fadeIn delay-02s">
					<li><a href="#" data-filter="*" class="current">All</a></li>
					<li><a href="#" data-filter=".branding">Ford</a></li>
					<li><a href="#" data-filter=".webdesign">Renault</a></li>
					<li><a href="#" data-filter=".printdesign">Hyundai</a></li>
					<li><a href="#" data-filter=".photography">Volkswagen</a></li>
                                        <li><a href="#" data-filter=".vovlo">Volvo</a></li>
